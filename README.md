...
- [Бизнес интерпретация](#Бизнес-интерпретация)
...
│       ├── logisctic_regression_custom.py      # Кастомная логистическая регрессия
...
- Ушло за 6 лет: **1 869 (26.5%)**
- Среднемесячный отток: **0.37%** (≈26 клиентов/мес.)
- ARPU: **64 у.е./мес.**
- Скидка для удержания: **10%** (6.4 у.е.)

---

### 1. Стратегия "Скидка всем 10%"
- Траты на скидки: 7 043 × 6.4 = **45 075 у.е./мес.**
- Отток не предотвращается
- **Итог: убыток 45 075 у.е./мес.**

---

### 2. Стратегия модели (точечные скидки)
- Модель находит 82% уходящих → **21 клиент**
- Из них реально уходящих (Precision 0.51): **11 клиентов**
- Затраты на скидки: 21 × 6.4 = **134 у.е./мес.**
- Сохранённая выручка: 11 × 64 = **704 у.е./мес.**
- **Чистая выгода: 704 − 134 = 570 у.е./мес.**

---

### Сравнение
| Стратегия | Траты на скидки | Сохранённая выручка | Чистый эффект |
|-----------|----------------|-------------------|------------|
| Скидка всем | 45 075 у.е. | 0 | −45 075 у.е. |
| Модель | 134 у.е. | 704 у.е. | +570 у.е |

**Вывод:** модель сокращает нецелевые траты и приносит чистую прибыль **570 у.е./мес.** (≈6 840 у.е./год).
