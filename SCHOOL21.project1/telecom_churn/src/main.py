...
if __name__ == "__main__":
    ...
    model_custom = LogisticRegressionCustom(penalty='l2', lambd=0.01, max_iter=100000, random_state=42, test_size=0.2, learning_rate=0.001, is_standard_split=0)
    ...
    model_orig = LogisticRegressionOriginal(penalty='l2', lambd=0.01, max_iter=100000, class_weight='balanced', random_state=42, test_size=0.4, is_standard_split=0)
